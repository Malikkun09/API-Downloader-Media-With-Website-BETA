...
# Usage
downloader = MLIKFJRMediaDownloader('MLIKFJR_PRO_mQ8X9Z2H0N4SAV1Rk7fT5cP6JEBWDLy')
...
pm2 start src/server.js --name "mlikfjr-api"
pm2 startup
pm2 save
```
...
```bash
# View logs
pm2 logs mlikfjr-api

# Follow logs
pm2 logs mlikfjr-api --lines 100 -f
```
...
**MLIKFJR Media Downloader API v2.0** - Professional Grade Media Downloader untuk WhatsApp Bot